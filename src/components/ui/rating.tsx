...
const RatingItem = ({
  ...
  const getRatingPoint = React.useCallback(
    (event: React.MouseEvent<HTMLLabelElement>) => {
      ...
      if (width === 0 || !checkPrecision(precision)) {
        return 0;
      }
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: https://github.com/shadcn-ui/ui/issues/1107#issuecomment-2970504230
...
const Rating = React.forwardRef<HTMLDivElement, RatingProps>(
  (
    ...
    return (
      // biome-ignore lint/a11y/noStaticElementInteractions: https://github.com/shadcn-ui/ui/issues/1107#issuecomment-2970504230
      // biome-ignore lint/a11y/useAriaPropsSupportedByRole: https://github.com/shadcn-ui/ui/issues/1107#issuecomment-2970504230
      <div
        ref={ref}
